...
class GameManager:
    ...
    def start_game(self):
        ...
        # Get song speed multiplier
        current_song_obj = self.song_manager.get_song(self.song_manager.current_song)
        speed_multiplier = getattr(current_song_obj, 'speed_multiplier', 1.0)
        
        final_speed = difficulty_speed * speed_multiplier
